...
global $nako3, $__v0, $__v1, $__v2;
  ...
  ;$__v0['line']="l38:api.nako3";//# パラメータ確認
  $__v0['line']="l38:api.nako3";if ((($__v2["PW"] == "") || ($__v2["KEY"] == ""))) {
  ...
  ;;$__v0['line']="l43:api.nako3";
  $__v0['line']="l43:api.nako3";if ($__locals["それ"]) {
    ;$__v0['line']="l44:api.nako3";
  ;$__v2["VALUE"]=$__locals["それ"]["value"];
  ;$__v0['line']="l45:api.nako3";
  ;$__locals["MTIME"]=$__locals["それ"]["mtime"];
  ;$__v0['line']="l46:api.nako3";
  $__locals["それ"] = $__v1["成功表示"]($__v2["VALUE"],$__locals["MTIME"],$nako3);
  ;;$__v0['line']="l47:api.nako3";
  
  }else {;$__v0['line']="l48:api.nako3";
  $__locals["それ"] = $__v1["エラー表示"]("見つかりません。",$nako3);
  ;;$__v0['line']="l49:api.nako3";
  };
  ;
  ;$__v0['line']="l49:api.nako3";
...
global $nako3, $__v0, $__v1, $__v2;
  ...
  ;$__v0['line']="l54:api.nako3";//# パラメータ確認
  $__v0['line']="l54:api.nako3";if ((($__v2["PW"] == "") || ($__v2["KEY"] == ""))) {
  ...
  $__locals["それ"] = $__v1["成功表示"]("完了",$__v2["TIME"],$nako3);
  ;;$__v0['line']="l63:api.nako3";
  
  }else {;$__v0['line']="l64:api.nako3";
...
global $nako3, $__v0, $__v1, $__v2;
  ...
  $__locals["それ"] = $__v0["JSONエンコード"](["result" => "error","reason" => $__locals["S"],"api_version" => $__v2["API_VERSION"]],$nako3);
...
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  $__locals["S"] = func_get_arg(0);
  $__locals["MTIME"] = func_get_arg(1);
  ;$__v0['line']="l87:api.nako3";
  $__v0["ヘッダ設定"]("Access-Control-Allow-Origin: *",$nako3);
  ;;$__v0['line']="l88:api.nako3";
  $__v0["ヘッダ設定"]("Content-Type: application/json",$nako3);
  ;;$__v0['line']="l89:api.nako3";
  $__locals["それ"] = $__v0["JSONエンコード"](["result" => "ok","value" => $__locals["S"],"time" => $__locals["MTIME"],"api_version" => $__v2["API_VERSION"]],$nako3);
  /*[sore]*/ $__v0["表示"]($__locals["それ"],$nako3);
  ;;$__v0['line']="l90:api.nako3";
...
$__v2["それ"] = $__v0["GET取得"]("time","0",$nako3);
;$__v2["TIME"]=$__v2["それ"];
;;$__v0['line']="l16:api.nako3";
;$__v0['line']="l17:api.nako3";
;$__v0['line']="l18:api.nako3";//# 値チェック
$__v0['line']="l18:api.nako3";if (($__v2["それ"] = $__v0["文字数"]($__v2["KEY"],$nako3) > 1024)) {
...
$__v0['line']="l21:api.nako3";if (($__v2["それ"] = $__v0["文字数"]($__v2["VALUE"],$nako3) > $__v2["最大値文字数"])) {
...
;$__v0['line']="l23:api.nako3";
;$__v0['line']="l24:api.nako3";
;$__v2["TIME"]=$__v2["それ"] = $__v0["INT"]($__v2["TIME"],$nako3);
;$__v0['line']="l25:api.nako3";
if (($__v2["TIME"] == 0)) {
  ;$__v2["TIME"]=$__v2["それ"] = $__v0["システム時間ミリ秒"]($nako3);

};
$__v0['line']="l28:api.nako3";if (($__v2["MODE"] == "get")) {
  ;$__v0['line']="l29:api.nako3";
$__v2["それ"] = $__v1["取得処理"]($nako3);
;;$__v0['line']="l30:api.nako3";

}else {$__v0['line']="l30:api.nako3";if (($__v2["MODE"] == "set")) {
  ;$__v0['line']="l31:api.nako3";
$__v2["それ"] = $__v1["設定処理"]($nako3);
;;$__v0['line']="l32:api.nako3";

}else {;$__v0['line']="l33:api.nako3";
$__v2["それ"] = $__v1["エラー表示"]("指定のmodeがありません。",$nako3);
;;$__v0['line']="l34:api.nako3";
};
;
};
;
...
;;$__v0['line']="l91:api.nako3";
;$__v0['line']="l92:api.nako3";
;//---
