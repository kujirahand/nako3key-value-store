...
global $nako3, $__v0, $__v1, $__v2;
  ...
  ;$__v0['line']="l48:admin.nako3";//# パラメータ確認
  $__v0['line']="l48:admin.nako3";if ((($__v2["PW"] == "") || ($__v2["KEY"] == ""))) {
  ...
  $__v0['line']="l53:admin.nako3";if ($__locals["それ"]) {
  ...
  ;$__v0['line']="l55:admin.nako3";
  ;$__v0['line']="l56:admin.nako3";
  ;$__v0['line']="l57:admin.nako3";//# 生成
...
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  ;$__v0['line']="l63:admin.nako3";
  ;$__v0['line']="l64:admin.nako3";//# パラメータ確認
  $__v0['line']="l64:admin.nako3";if ((($__v2["PW"] == "") || ($__v2["KEY"] == ""))) {
  ...
  $__v0['line']="l69:admin.nako3";if ($__locals["それ"]) {
    ;$__v0['line']="l70:admin.nako3";
  ;$__v2["VALUE"]=$__locals["それ"]["value"];
  ;$__v0['line']="l71:admin.nako3";
  ...
  ;$__v0['line']="l77:admin.nako3";$__locals["MSG"]=$__locals["それ"];
  ;;$__v0['line']="l78:admin.nako3";
  $__locals["それ"] = $__v1["画面表示"]((("キー『" . $__v2["KEY"]) . "』の値"),$__locals["MSG"],$nako3);
  ;;$__v0['line']="l79:admin.nako3";
  
  }else {;$__v0['line']="l80:admin.nako3";
...
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  ;$__v0['line']="l85:admin.nako3";
  ;$__v0['line']="l86:admin.nako3";//# パラメータ確認
  $__v0['line']="l86:admin.nako3";if ((($__v2["PW"] == "") || ($__v2["KEY"] == ""))) {
  ...
  $__v0['line']="l91:admin.nako3";if ($__locals["それ"]) {
  ...
  $__v0['line']="l94:admin.nako3";if (($__locals["CNT"] >= 1)) {
  ...
  }else {;$__v0['line']="l97:admin.nako3";
  ...
  }else {;$__v0['line']="l100:admin.nako3";
  $__locals["それ"] = $__v1["エラー表示"]("見つかりません。",$nako3);
  ;$__v0["終"]($nako3);
...
global $nako3, $__v0, $__v1, $__v2;
  ...
  $__v0['line']="l112:admin.nako3";if (($__locals["F"] == $__v0["いいえ"])) {
...
$__v0['line']="l28:admin.nako3";if (($__v2["それ"] = $__v0["文字数"]($__v2["KEY"],$nako3) > 1024)) {
...
$__v0['line']="l31:admin.nako3";if (($__v2["それ"] = $__v0["文字数"]($__v2["VALUE"],$nako3) > $__v2["最大値文字数"])) {
