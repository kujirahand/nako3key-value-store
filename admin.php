<?php
    //-----------------------------------------------
    // 【なでしこ3PHP】「admin.nako3」から自動生成されたコード
    //-----------------------------------------------
    // global 設定
...
;//[/DEF_FUNC name='admin__トップ画面']
//[DEF_FUNC name='admin__統計情報取得']
$__v1["admin__統計情報取得"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
...
;//[/DEF_FUNC name='admin__統計情報取得']
//[DEF_FUNC name='admin__作成処理']
$__v1["admin__作成処理"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  ;$__v0['line']="l105:admin.nako3";
  ;$__v0['line']="l106:admin.nako3";//# パラメータ確認
  $__v0['line']="l106:admin.nako3";if ((($__v2["admin__PW"] == "") || ($__v2["admin__KEY"] == ""))) {
    ;$__v0['line']="l107:admin.nako3";
  $__locals["それ"] = $__v1["admin__エラー表示"]("keyとpasswordが必要です",$nako3);
  ;$__v0["終"]($nako3);
  ...
  ;$__locals["PWハッシュ"]=$__locals["それ"] = $__v1["admin__PWハッシュ取得"]($__v2["admin__PW"],$nako3);
  ;;$__v0['line']="l110:admin.nako3";
  $__locals["それ"] = $__v0["PDO一行取得"]("SELECT * FROM items WHERE key=?",[$__v2["admin__KEY"]],$nako3);
  ;;$__v0['line']="l111:admin.nako3";
  $__v0['line']="l111:admin.nako3";if ($__locals["それ"]) {
    ;$__v0['line']="l112:admin.nako3";
  $__locals["それ"] = $__v1["admin__エラー表示"]("既にkeyが存在しています。",$nako3);
  ;$__v0["終"]($nako3);
  ...
  ;$__v0['line']="l115:admin.nako3";//# 生成
  ;$__locals["T"]=$__locals["それ"] = $__v0["システム時間ミリ秒"]($nako3);
  ;;$__v0['line']="l116:admin.nako3";
  $__locals["それ"] = $__v0["PDO実行"]("INSERT INTO items (key,value,password,ctime,mtime) VALUES (?,?,?,?,?)",[$__v2["admin__KEY"],$__v2["admin__VALUE"],$__locals["PWハッシュ"],$__locals["T"],$__locals["T"]],$nako3);
  ;;$__v0['line']="l117:admin.nako3";
  $__locals["それ"] = $__v1["admin__画面表示"]((("キー:" . $__v2["admin__KEY"]) . ""),(("作成完了。<a href=\"" . $__v2["admin__ADMIN_PAGE"]) . "\">→戻る</a>"),$nako3);
  ;;$__v0['line']="l118:admin.nako3";
  
  return ($__locals["それ"]);
});
;//[/DEF_FUNC name='admin__作成処理']
//[DEF_FUNC name='admin__取得処理']
$__v1["admin__取得処理"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  ;$__v0['line']="l121:admin.nako3";
  ;$__v0['line']="l122:admin.nako3";//# パラメータ確認
  $__v0['line']="l122:admin.nako3";if ((($__v2["admin__PW"] == "") || ($__v2["admin__KEY"] == ""))) {
    ;$__v0['line']="l123:admin.nako3";
  $__locals["それ"] = $__v1["admin__エラー表示"]("keyとpasswordが必要です",$nako3);
  ;$__v0["終"]($nako3);
  ...
  ;$__locals["PWH"]=$__locals["それ"] = $__v1["admin__PWハッシュ取得"]($__v2["admin__PW"],$nako3);
  ;;$__v0['line']="l126:admin.nako3";
  $__locals["それ"] = $__v0["PDO一行取得"]("SELECT * FROM items WHERE key=? AND password=?",[$__v2["admin__KEY"],$__locals["PWH"]],$nako3);
  ;;$__v0['line']="l127:admin.nako3";
  $__v0['line']="l127:admin.nako3";if ($__locals["それ"]) {
    ;$__v0['line']="l128:admin.nako3";
  ;$__v2["admin__VALUE"]=$__locals["それ"]["value"];
  ;$__v0['line']="l129:admin.nako3";
  ;$__locals["MTIME"]=($__locals["それ"]["mtime"] / 1000);
  ;$__v0['line']="l130:admin.nako3";
  $__locals["それ"] = $__v0["HTML埋込"]((((("\n            <div>\n            	<div>" . $__v2["admin__KEY"]) . "の値:</div>\n            	<div class=\"vcode\"><code>[[CODE]]</code></div>\n            	<div class=\"hint\">更新日時: [[MTIME|datetime]]</div>\n            </div>\n            <div><br><a href=\"") . $__v2["admin__ADMIN_PAGE"]) . "\">→戻る</a></div>\n             "),["CODE" => $__v2["admin__VALUE"],"KEY" => $__v2["admin__KEY"],"MTIME" => $__locals["MTIME"]],$nako3);
  ;$__v0['line']="l137:admin.nako3";$__locals["MSG"]=$__locals["それ"];
  ;;$__v0['line']="l138:admin.nako3";
  $__locals["それ"] = $__v1["admin__画面表示"]((("キー『" . $__v2["admin__KEY"]) . "』の値"),$__locals["MSG"],$nako3);
  ;;$__v0['line']="l139:admin.nako3";
  
  }else {;$__v0['line']="l140:admin.nako3";
  $__locals["それ"] = $__v1["admin__エラー表示"]("見つかりません。",$nako3);
...
;//[/DEF_FUNC name='admin__取得処理']
//[DEF_FUNC name='admin__設定処理']
$__v1["admin__設定処理"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  ;$__v0['line']="l145:admin.nako3";
  ;$__v0['line']="l146:admin.nako3";//# パラメータ確認
  $__v0['line']="l146:admin.nako3";if ((($__v2["admin__PW"] == "") || ($__v2["admin__KEY"] == ""))) {
  ...
  $__v0['line']="l151:admin.nako3";if ($__locals["それ"]) {
    ;$__v0['line']="l152:admin.nako3";
  ;$__locals["T"]=$__locals["それ"] = $__v0["システム時間ミリ秒"]($nako3);
  ;;$__v0['line']="l153:admin.nako3";
  ;$__locals["CNT"]=$__locals["それ"] = $__v0["PDO実行"]("UPDATE items SET value=?,mtime=? WHERE key=? AND password=?",[$__v2["admin__VALUE"],$__locals["T"],$__v2["admin__KEY"],$__locals["PWH"]],$nako3);
  ;;$__v0['line']="l154:admin.nako3";
  $__v0['line']="l154:admin.nako3";if (($__locals["CNT"] >= 1)) {
    ;$__v0['line']="l155:admin.nako3";
  $__locals["それ"] = $__v1["admin__画面表示"]((("値の更新完了: " . $__v2["admin__KEY"]) . ""),(("<a href=\"" . $__v2["admin__ADMIN_PAGE"]) . "\">更新完了。戻る</a>"),$nako3);
  ;;$__v0['line']="l156:admin.nako3";
  
  }else {;$__v0['line']="l157:admin.nako3";
  $__locals["それ"] = $__v1["admin__エラー表示"]("更新できません。",$nako3);
  ;$__v0["終"]($nako3);
  ...
  }else {;$__v0['line']="l160:admin.nako3";
  $__locals["それ"] = $__v1["admin__エラー表示"]("見つかりません。",$nako3);
  ;$__v0["終"]($nako3);
...
;//[/DEF_FUNC name='admin__設定処理']
//[DEF_FUNC name='admin__PWハッシュ取得']
$__v1["admin__PWハッシュ取得"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
...
;//[/DEF_FUNC name='admin__PWハッシュ取得']
//[DEF_FUNC name='admin__初期設定実行']
$__v1["admin__初期設定実行"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  ;$__v0['line']="l170:admin.nako3";
  ;$__locals["F"]=$__locals["それ"] = $__v0["存在"]($__v2["admin__メインDB"],$nako3);
  ;$__v0['line']="l171:admin.nako3";
  $__locals["それ"] = $__v0["PDO生成"]((("sqlite:" . $__v2["admin__メインDB"]) . ""),$nako3);
  ;;$__v0['line']="l172:admin.nako3";
  $__v0['line']="l172:admin.nako3";if (($__locals["F"] == $__v0["いいえ"])) {
    ;$__v0['line']="l173:admin.nako3";
  $__locals["それ"] = $__v0["PDO実行"]($__v2["admin__初期化SQL"],[],$nako3);
...
;//[/DEF_FUNC name='admin__初期設定実行']
//[DEF_FUNC name='admin__エラー表示']
$__v1["admin__エラー表示"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  $__locals["S"] = func_get_arg(0);
  ;$__v0['line']="l179:admin.nako3";
  $__locals["それ"] = $__v0["HTML埋込"]((((("" . $__locals["それ"] = $__v1["admin__HTMLヘッダ取得"]("エラー",$nako3)) . "\n<h1 class=\"error\">エラー</h1>\n<div class=\"box-error\">\n[[エラー]]\n</div>\n") . $__locals["それ"] = $__v1["admin__HTMLフッタ取得"]($nako3)) . ""),["エラー" => $__locals["S"],"アプリタイトル" => $__v2["admin__アプリタイトル"]],$nako3);
...
;//[/DEF_FUNC name='admin__エラー表示']
//[DEF_FUNC name='admin__画面表示']
$__v1["admin__画面表示"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  $__locals["TITLE"] = func_get_arg(0);
  $__locals["MSG"] = func_get_arg(1);
  ;$__v0['line']="l191:admin.nako3";
  $__locals["それ"] = $__v0["HTML埋込"]((((("" . $__locals["それ"] = $__v1["admin__HTMLヘッダ取得"]($__locals["TITLE"],$nako3)) . "\n<h1>[[タイトル]]</h1>\n<div class=\"box\">\n[[メッセージ|raw]]\n</div>\n") . $__locals["それ"] = $__v1["admin__HTMLフッタ取得"]($nako3)) . ""),["タイトル" => $__locals["TITLE"],"メッセージ" => $__locals["MSG"],"アプリタイトル" => $__v2["admin__アプリタイトル"]],$nako3);
  /*[sore]*/ $__v0["表示"]($__locals["それ"],$nako3);
...
;//[/DEF_FUNC name='admin__画面表示']
//[DEF_FUNC name='admin__HTMLヘッダ取得']
$__v1["admin__HTMLヘッダ取得"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  $__locals["タイトル"] = func_get_arg(0);
  ;$__v0['line']="l204:admin.nako3";
  ;$__locals["それ"]=(((((("\n<!DOCTYPE html>\n<html>\n<head>\n  <meta charset=\"UTF-8\">\n  <title>" . $__locals["タイトル"]) . " - ") . $__v2["admin__アプリタイトル"]) . "</title>\n  <link href=\"./res/admin.css\" rel=\"stylesheet\">\n</head>\n<body>\n<div id=\"menubar\">\n    <a href=\"https://nadesi.com/v3/doc/go.php?4637\">なでしこ3サーバーAPI</a>\n    &gt;\n    <a href=\"") . $__v2["admin__ADMIN_PAGE"]) . "\">管理画面</a>\n</div><!-- menubar -->\n");
  ;$__v0['line']="l219:admin.nako3";
  
  return ($__locals["それ"]);
});
;//[/DEF_FUNC name='admin__HTMLヘッダ取得']
//[DEF_FUNC name='admin__HTMLフッタ取得']
$__v1["admin__HTMLフッタ取得"]=(function(){
global $nako3, $__v0, $__v1, $__v2;
  $__locals = ['それ'=>''];
  ;$__v0['line']="l222:admin.nako3";
  ;$__locals["それ"]=(("\n<!-- footer -->\n<div id=\"footer\">\n    <a href=\"https://nadesi.com/v3/doc/go.php?4637\">なでしこ3サーバーAPI</a>\n    &gt;\n    <a href=\"" . $__v2["admin__ADMIN_PAGE"]) . "\">管理画面</a>\n</div>\n</body>\n</html>");
  ;$__v0['line']="l231:admin.nako3";
...
;//[/DEF_FUNC name='admin__HTMLフッタ取得']
    ...
    // <require_once src="plugin_math">
    // 取り込むファイルのパスを解決
    $mod_file = __DIR__.'/src/plugin_math.php';
    if (defined('PHPNAKO_RUNTIME_PATH')) {
      $mod_file = PHPNAKO_RUNTIME_PATH.'/plugin_math.php';
    }
    if (empty($nako3['__module']['plugin_math'])) {
      require_once $mod_file;
      $nako3['__module']['plugin_math'] = $exports;
      foreach ($exports as $name => $v) { // import to v0
        if ($v['type'] == 'func') { $__v0[$name] = $v['fn']; }
        else { $__v0[$name] = $v['value']; }
      }
    ...
    // 変換コード
    try {
    $__v0['line']="l0:admin.nako3";;//undefined
;;$__v0['line']="l1:admin.nako3";//# === なでしこ3API / Key-Valueストア
;$__v0['line']="l2:admin.nako3";//# 各種設定
;$__v2["admin__アプリタイトル"]="なでしこ3簡単保存API";
;$__v0['line']="l3:admin.nako3";
;$__v2["admin__DB保存フォルダ"]=(("" . $__v0["母艦パス"]) . "/db");
;$__v0['line']="l4:admin.nako3";
;$__v2["admin__メインDB"]=(("" . $__v2["admin__DB保存フォルダ"]) . "/db1.sqlite3");
;$__v0['line']="l5:admin.nako3";
;$__v2["admin__最大キー"]=2000;
;$__v0['line']="l6:admin.nako3";//# 保存可能なキーの数を定義
;$__v2["admin__最大値文字数"]=((1024 * 1024) * 3);
...
;$__v2["admin__ADMIN_PAGE"]="admin.php";
;$__v0['line']="l19:admin.nako3";
$__v2["それ"] = $__v1["admin__初期設定実行"]($nako3);
;;$__v0['line']="l20:admin.nako3";
;$__v0['line']="l21:admin.nako3";
;$__v0['line']="l22:admin.nako3";//# パラメータ取得
$__v2["それ"] = $__v0["GET取得"]("mode","",$nako3);
;$__v2["admin__MODE"]=$__v2["それ"];
;;$__v0['line']="l23:admin.nako3";
$__v2["それ"] = $__v0["GET取得"]("key","",$nako3);
;$__v2["admin__KEY"]=$__v2["それ"];
;;$__v0['line']="l24:admin.nako3";
$__v2["それ"] = $__v0["GET取得"]("value","",$nako3);
;$__v2["admin__VALUE"]=$__v2["それ"];
;;$__v0['line']="l25:admin.nako3";
$__v2["それ"] = $__v0["GET取得"]("password","",$nako3);
;$__v2["admin__PW"]=$__v2["それ"];
;;$__v0['line']="l26:admin.nako3";
;$__v0['line']="l27:admin.nako3";
;$__v0['line']="l28:admin.nako3";//# 値チェック
$__v0['line']="l28:admin.nako3";if (($__v2["それ"] = $__v0["文字数"]($__v2["admin__KEY"],$nako3) > 1024)) {
  ;$__v0['line']="l29:admin.nako3";
$__v2["それ"] = $__v1["admin__エラー表示"]("keyの文字数が1024を超えています。",$nako3);
;$__v0["終"]($nako3);
...
$__v0['line']="l31:admin.nako3";if (($__v2["それ"] = $__v0["文字数"]($__v2["admin__VALUE"],$nako3) > $__v2["admin__最大値文字数"])) {
  ;$__v0['line']="l32:admin.nako3";
$__v2["それ"] = $__v1["admin__エラー表示"]((("valueの文字数が" . $__v2["admin__最大値文字数"]) . "を超えています。"),$nako3);
;$__v0["終"]($nako3);
...
;$__v0['line']="l36:admin.nako3";//# MODEで分岐
$__v0['line']="l36:admin.nako3";if (($__v2["admin__MODE"] == "create")) {
  ;$__v0['line']="l37:admin.nako3";
$__v2["それ"] = $__v1["admin__作成処理"]($nako3);
;;$__v0['line']="l38:admin.nako3";

}else {$__v0['line']="l38:admin.nako3";if (($__v2["admin__MODE"] == "get")) {
  ;$__v0['line']="l39:admin.nako3";
$__v2["それ"] = $__v1["admin__取得処理"]($nako3);
;;$__v0['line']="l40:admin.nako3";

}else {$__v0['line']="l40:admin.nako3";if (($__v2["admin__MODE"] == "set")) {
  ;$__v0['line']="l41:admin.nako3";
$__v2["それ"] = $__v1["admin__設定処理"]($nako3);
;;$__v0['line']="l42:admin.nako3";

}else {;$__v0['line']="l43:admin.nako3";
$__v2["それ"] = $__v1["admin__トップ画面"]($nako3);
...
;;$__v0['line']="l232:admin.nako3";
;$__v0['line']="l233:admin.nako3";
